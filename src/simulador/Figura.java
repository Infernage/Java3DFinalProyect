...
public class Figura  {
 ...
 public void  crearPropiedades(float masa, float elasticidad, float dampingLineal, float posX, float posY, float posZ,  DiscreteDynamicsWorld mundoFisico ){
       ...
       //Creaciîn de un cuerpoRigido (o RigidBody) con sus propiedades fisicas 
        ...
        if  (isDynamic && !esMDL)   this.ramaFisica.getCollisionShape().calculateLocalInertia(masa, inerciaLocal);
 ...
 public void remover(){
       if ( ! juego.mostrandoFisicas)
           try{     mundoFisico.getCollisionObjectArray().remove(this.identificadorFisico);
           ...
           }catch (Exception e){System.out.println("Ya eliminado");}
   }
